...
class ScanReport:
            ...
            [
                {
                    ...
                    "slicing_fn": str(issue.slicing_fn)
                    if issue.slicing_fn
                    else None,
    ...
    def generate_test_suite(self, name=None):
        ...
        if self.model:
            suite_default_params["model"] = self.model
        if self.dataset:
            suite_default_params["dataset"] = self.dataset
    ...
    def to_mlflow(
        ...
        if model_artifact_path != "":
            model_artifact_path = f"-for-{model_artifact_path}"
